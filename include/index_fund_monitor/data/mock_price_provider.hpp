#ifndef INDEX_FUND_MONITOR_DATA_MOCK_PRICE_PROVIDER_HPP
#define INDEX_FUND_MONITOR_DATA_MOCK_PRICE_PROVIDER_HPP

#include <string>

#include "index_fund_monitor/data/iprice_provider.hpp"

class MockPriceProvider : public IPriceProvider {
public:
    explicit MockPriceProvider(std::string fixture_dir);
    PriceResult fetch(const std::string& symbol) override;
